...
public class MeshrModuleParser extends Parser {
	...
	public final CompilationUnitContext compilationUnit() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 243194388467941760L) != 0) || ((((_la - 77)) & ~0x3f) == 0 && ((1L << (_la - 77)) & 1149L) != 0)) {
				{
				setState(325);
				_errHandler.sync(this);
	...
	public final AnnotationContext annotation() throws RecognitionException {
		...
		try {
			...
			if (_la==T__9) {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2305846380559597568L) != 0) || ((((_la - 78)) & ~0x3f) == 0 && ((1L << (_la - 78)) & 60129542145L) != 0)) {
					{
					setState(813);
					annotationArgs();
					}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(1306);
						_la = _input.LA(1);
						if ( !(((((_la - 3)) & ~0x3f) == 0 && ((1L << (_la - 3)) & 3458764513820540929L) != 0)) ) {
						_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
					...
					case 3:
						...
						setState(1312);
						_la = _input.LA(1);
						if ( !(((((_la - 15)) & ~0x3f) == 0 && ((1L << (_la - 15)) & 69805794224242689L) != 0)) ) {
						_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final FunctionCallContext functionCall() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2305846380559598592L) != 0) || ((((_la - 78)) & ~0x3f) == 0 && ((1L << (_la - 78)) & 60129542145L) != 0)) {
				{
				setState(1330);
				expression(0);
				setState(1335);

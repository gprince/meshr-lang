...
function activate(context) {
    console.log('Extension Meshr-Lang avec serveur LSP complet activée !');
    // Afficher un message de confirmation
    vscode.window.showInformationMessage('🎉 Extension Meshr-Lang avec serveur LSP complet activée !');
    ...
    context.subscriptions.push(vscode.commands.registerCommand('meshr-lang.restartServer', async () => {
        if (client) {
            await client.stop();
            client.start();
    ...
    context.subscriptions.push(vscode.commands.registerCommand('meshr-lang.test', () => {
...
//# sourceMappingURL=extension_proper.js.map